        ...
        signInbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(Email) && !TextUtils.isEmpty(pass)) {
                    mAuth.signInWithEmailAndPassword(Email, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(DoctorLoginActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                mprogressBar.setVisibility(View.GONE);
                                Log.i("success","No");
                            }
                        }
                    ...
                    Toast.makeText(DoctorLoginActivity.this, "Please Enter All Fields ", Toast.LENGTH_SHORT).show();
                    mprogressBar.setVisibility(View.GONE);
                }
            }
        });
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild(user_id)) {
                    Intent loginIntent = new Intent(DoctorLoginActivity.this, DocterActivity.class);
                    startActivity(loginIntent);
                }
                else{
                    Log.i("accessf",user_id);
                    Toast.makeText(DoctorLoginActivity.this, "Sorry ! You don't have access ", Toast.LENGTH_SHORT).show();
                }
            }
            @Override
