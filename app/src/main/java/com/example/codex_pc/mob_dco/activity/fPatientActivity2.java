...
import com.example.codex_pc.mob_dco.fragments.DisplayListFragment;
import com.example.codex_pc.mob_dco.fragments.NutrientCalculateFragments;
...
//        transaction.commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            startActivity(new Intent(fPatientActivity2.this, AboutActivity.class));
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    ...
                    return display;
                case 1:
                    NutrientCalculateFragments nutri = new NutrientCalculateFragments();
                    return nutri;
                default:
                    return null;
            }
