...
public static final int RC_PHOTO_PICKER = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signIn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PatientSignUpActivity.this, PatientSignInActivity.class));
                finish();
                }
        });
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (! usernmae.getText().toString().isEmpty() && !password.getText().toString().isEmpty()&&!email.getText().toString().isEmpty()
                            ...
                            mauth.createUserWithEmailAndPassword(email_content,password_content).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        startActivity(new Intent(PatientSignUpActivity.this, fPatientActivity2.class));
                                        finish();
                                        progressBar.setVisibility(View.GONE);
                                        Toast.makeText(PatientSignUpActivity.this, "Successfully Registered !", Toast.LENGTH_SHORT).show();

                                    }else {
                                        Toast.makeText(PatientSignUpActivity.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                    ...
                    Toast.makeText(PatientSignUpActivity.this, "Please enter all details.", Toast.LENGTH_SHORT).show();
                }
            }
        });
