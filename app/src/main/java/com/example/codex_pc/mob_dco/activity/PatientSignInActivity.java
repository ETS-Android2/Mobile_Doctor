        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(email) && !TextUtils.isEmpty(pass)) {
                    ...
                    Toast.makeText(PatientSignInActivity.this, "Please fill all details", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild(user_id)) {
                    Intent loginIntent = new Intent(PatientSignInActivity.this, fPatientActivity2.class);
                    ...
                    if(FirebaseAuth.getInstance().getCurrentUser() != null){
                        AuthUI.getInstance().signOut(PatientSignInActivity.this);
                    }
                    Toast.makeText(PatientSignInActivity.this, "Not Registered, then Please Register.", Toast.LENGTH_SHORT).show();
                }
            }
            @Override
